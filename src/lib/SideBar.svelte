<script>
	...
	import OpenRouterTab from './OpenRouterTab.svelte';
	...
	const icons = [
		...
		{ icon: 'fas fa-robot', info: 'OpenRouter AI', activity: aiActivity },
		null,
...
<div class="flex flex-row w-14 h-full bg-neutral-700" >
	...
	>
		...
		{:else if activeInfo === 'Disk'}
			<DiskTab on:reset/>
		{:else if activeInfo === 'OpenRouter AI'}
			<OpenRouterTab handleTool={handleTool} />
