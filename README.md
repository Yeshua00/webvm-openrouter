...
- [How to use OpenRouter AI](#how-to-use-openrouter-ai)
...
To access AI models through OpenRouter, you need an API key. Follow these steps to get started:

### 1. Create an account
- Visit [OpenRouter](https://openrouter.ai) and sign up with your e-mail.
- OpenRouter provides access to Claude, GPT, Gemini, Llama, and other models through a unified API.

### 2. Get your API key
- Once logged in, navigate to **API Keys**.
- You can get free credits for testing, or add funds to your account.
- Generate a new API key (starts with `sk-or-v1-...`)

### 3. Log in with your API key
- Navigate to your WebVM and hover over the robot icon. This will show the OpenRouter AI Integration tab. For added convenience, you can click the pin button in the top right corner to keep the tab in place.
- You'll see a prompt where you can insert your OpenRouter API key.
- Insert your key and press enter.

### 4. Start using AI
- Once your API key is entered, you can begin interacting with AI by asking questions such as:

 __"Solve the CTF challenge at `/home/user/chall1.bin.` Note that the binary reads from stdin."__

**Note:** This version uses OpenRouter to route requests to Claude models. The default model is Claude Sonnet 4, which supports computer use (mouse, keyboard, screenshots) and terminal commands.
